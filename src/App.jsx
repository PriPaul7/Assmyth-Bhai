...
function App() {
  ...
  return (
    ...
    <Countdown onBirthdayReached={handleBirthdayReached} />
          ...
          <p> The best gurl, best person, my best friend, my all time fav person 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — [Priyanshu] 💖</h2>
          <p className="final-subtitle">STAY HAPPY AND BLESSED ✨</p>
        </section>
      </div>
